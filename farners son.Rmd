...
ggplot(merged_data, aes(x = male, fill = agri_son)) +
  geom_bar(position = 'dodge', aes(y =..count../tapply(..count.., ..x.. ,sum)[..x..])) +
  labs(title = "Percentage of Farmers' Daughter/Son Working in Agriculture Based on Gender") +
  scale_y_continuous(labels = percent, name = 'percentage') +
  geom_text(aes(y=..count../tapply(..count.., ..x.. ,sum)[..x..],
                label=scales::percent(..count../tapply(..count.., ..x.. ,sum)[..x..]) ),
            stat="count", position=position_dodge(0.9), vjust=-0.5)+
...
```{r, fig.height=6, fig.width=9}
ggplot(merged_data, aes(x = as.factor(java), fill = agri_son)) +
  geom_bar(position = 'dodge', aes(y =..count../tapply(..count.., ..x.. ,sum)[..x..])) +
  labs(title = "Percentage of Farmers' Daughter/Son Working in Agriculture Based on Residency in Java") +
  scale_y_continuous(labels = percent, name = 'percentage') +
  geom_text(aes(y=..count../tapply(..count.., ..x.. ,sum)[..x..],
                label=scales::percent(..count../tapply(..count.., ..x.. ,sum)[..x..]) ),
            stat="count", position=position_dodge(0.9), vjust=-0.5)+
...
ggplot(merged_data, aes(x = urban, fill = agri_son)) +
  geom_bar(position = 'dodge', aes(y =..count../tapply(..count.., ..x.. ,sum)[..x..])) +
  labs(title = "Percentage of Farmers' Daughter/Son Working in Agriculture Based on Residency in Rural/Urban") +
  scale_y_continuous(labels = percent, name = 'percentage') +
  geom_text(aes(y=..count../tapply(..count.., ..x.. ,sum)[..x..],
                label=scales::percent(..count../tapply(..count.., ..x.. ,sum)[..x..]) ),
            stat="count", position=position_dodge(0.9), vjust=-0.5)+
